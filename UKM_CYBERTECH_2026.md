...
```mermaid
graph TD
    classDef pembina fill:#0f203c,stroke:#00d4ff,stroke-width:2px,color:#fff;
    classDef ketum fill:#1b2a4a,stroke:#3b82f6,stroke-width:2px,color:#fff;
    classDef dph fill:#0d1e35,stroke:#2563eb,stroke-width:1px,color:#fff;
    classDef kadep fill:#112240,stroke:#38bdf8,stroke-width:1px,color:#fff;
    classDef kadiv fill:#0f172a,stroke:#e63946,stroke-width:1px,color:#fff;
    ...
    DeptPR["<b>Ka. Dept. PR</b><br/>Muhammad Raihan Pramana W."]:::kadep
